...
map_one_user = function( df_user_night, df_location, min_accuracy ) {
...
for( i in rownames(df_missing_summary %>% head(10)) )
  map_one_user(df_missing_summary [i,], df_location, min_accuracy)
...
for( i in rownames(df_missing_summary %>% head(10)) )
  plot_one_person_survey(df_missing_summary[i,], df_location,df_best, df_surveys_missed )
